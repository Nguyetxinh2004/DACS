        ...
        <div class="card my-3 shadow">
            ...
            <div class="card-body">
                ...
                <p class="card-text text-success fs-4 fw-bold">Trạng thái: 
                    <span class="text-black fw-medium">${order.isPending ? "Đơn hàng chưa được vận chuyển" : "Đơn hàng đã được chuẩn bị"}</span>
                </p>
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class = "text-success text-center">Tình trạng</th>
                                </tr>
                            </thead>
                            <tbody>
            ...
            : '<span class="text-danger fs-4 fw-bold"><i class="bi bi-x"></i></span>'
                                        ...
                                        <td class="text-center">${order.isPending ? "Đơn hàng chưa được xác nhận" : "Đơn hàng đã được xác nhận"}</td>
                                    </tr>
                                `).join('')
        }
                            </tbody >
